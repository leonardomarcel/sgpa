var idSelectEstado = "#id_0-endereco_estado";
var idSelectMunicipio = "#id_0-endereco_cidade";
var idSelectBairro = "#id_0-endereco_bairro";
...
function onChangeMunicipio() {
	$(idSelectMunicipio).change(function () {
		...
		if(!isNull(id_municipio)) {
			$("#id_0-municipio_id").val(id_municipio);
			...
			if(validacep.test(cep)) {
				$.getJSON('https://viacep.com.br/ws/'+ cep +'/json/', function(data) {
					if(data.erro) {
						...
						$('#id_0-logradouro').val(data.logradouro);
